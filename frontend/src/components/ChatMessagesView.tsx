...
const HumanMessageBubble: React.FC<HumanMessageBubbleProps> = ({
    ...
    return (
        <div
            className={`text-white font-semibold text-2xl break-words min-h-7 max-w-[100%] sm:max-w-[90%] px-4 pt-3`}
        >
...
// Need to add the card display after the final research output
                ...
                {messages.map((message, index) => {
                    ...
                    <div key={message.id || `msg-${index}`} className="space-y-3">
                        ...
                        className={`flex items-start gap-3 ${
                            message.type === "human" ? "justify-start" : ""
                        }`}
                        >
                        {message.type === "human" ? (
                            <HumanMessageBubble
